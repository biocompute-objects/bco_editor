...
JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    ...
    // If the object should be rendered as a div
      ...
      this.addproperty_list.style.width = '700px';
...
JSONEditor.AbstractTheme = Class.extend({
  ...
  getHeader: function(text) {
    var el = document.createElement('h5'); //Robel
  ...
  getSelectInput: function(options) {
    ...
    select.style.fontSize = '13px'; //Robel
    return select;
  },
  ...
  getFormInputField: function(type) {
    ...
    el.style.width = '90%'; //Robel
    el.style.height = '25px'; //Robel
...
JSONEditor.defaults.themes.bootstrap2 = JSONEditor.AbstractTheme.extend({
  ...
  getFormInputLabel: function(text) {
    ...
    el.style.display = 'inline-block';
    //el.style.fontWeight = 'normal'; //Robel
    return el;
  },
  setGridColumnSize: function(el,size) {
...
JSONEditor.defaults.themes.bootstrap3 = JSONEditor.AbstractTheme.extend({
  ...
  getFormControl: function(label, input, description) {
    ...
    if(label && input.type === 'checkbox') {
      ...
      label.appendChild(input);
      label.style.fontSize = '0.8em'; //Robel
...
JSONEditor.defaults.themes.html = JSONEditor.AbstractTheme.extend({
  ...
  getIndentedPanel: function() {
    ...
    //el.style.border = '1px dashed orange';
    el.style.padding = '10p 10px 10px 20px';
    el.style.width = '700px';
    el.style.margin = '10px 10px 10px 20px';
