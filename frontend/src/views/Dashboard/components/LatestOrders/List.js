...
const headCells = [
  ...
  { id: 'access_list', numeric: false, disablePadding: false, label: 'Access List' },
];
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar 
          ...
          onGotoNewBco={props.onGotoNewBco} 
